...
- **`resources/scss/welcome.scss`** — styles for the welcome page (`/api`)
- **`resources/scss/_variables.scss`** — SCSS variables for welcome page
- **`resources/css/app.css`** — Tailwind CSS (for other pages if needed)
...
│   ├── Requests/
│   │   ├── BaseBookRequest.php
│   │   ├── BookRequestRules.php
│   │   ├── IndexBookRequest.php
